...
for (i in c(1:length(df_pat))) {
  ...
  combin_tp <- expand.grid(levels(as.factor(df_pat[[i]]$extract_time)), levels(as.factor(df_pat[[i]]$extract_time)))
  combin_tp_df <- subset(combin_tp, !(combin_tp$Var2 %in% c("baseline")))
  combin_tp_df <- subset(combin_tp_df, !(combin_tp_df$Var1 == "12months"))
  clonedf_tp <- rbind(combin_tp_df, 
                      data.frame(Var1=c("baseline"), Var2=c("baseline")),
                      data.frame(Var1=c("12months"), Var2=c("12months")))
  ...
  # 
  #     # Upset plots
  #     #pdf(file = paste(patdir_overlap,"/Set_plot_", df_pop[[1]]$treatment[1], "_",df_pop[[1]]$extract_time[1], "_",df_pop[[1]]$source[1], ".pdf", sep="" ))
  #     
  ...
  #     #ggsave(paste(patdir_overlap,"/Set_plot_", df_pop[[1]]$treatment[1], "_",df_pop[[1]]$extract_time[1], "_",df_pop[[1]]$source[1], ".pdf", sep="" ))
  #     #dev.off()
  # 
...
ggplot(all_clonedf_tp_transformed, aes(x=source,y=delta_6)) +
  ...
  ggtitle("Increase in number of clone overlaps (# overlaps 6-12mo minus # overlaps B-6mo)") +
