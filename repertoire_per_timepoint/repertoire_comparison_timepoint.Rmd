...
gini_m <- df_gini_index[(df_gini_index$population=="M"),]
res_m_6_baseline <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_m[(gini_m$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_m_6_baseline
res_m_6_12 <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_m[(gini_m$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_m_6_12
res_m_b_12 <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_m[(gini_m$time_point %in% c("12months","baseline")),], 
                              paired = TRUE)
res_m_b_12

gini_dn <- df_gini_index[(df_gini_index$population=="DN"),]
res_dn_6_baseline <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_dn[(gini_dn$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_dn_6_baseline
res_dn_6_12 <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_dn[(gini_dn$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_dn_6_12

gini_n <- df_gini_index[(df_gini_index$population=="N"),]
gini_n <- gini_n[!(gini_n$patient=="CLAD4"),]
res_n_6_baseline <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_n[(gini_n$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_n_6_baseline
res_n_6_12 <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_n[(gini_n$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_n_6_12

gini_p <- df_gini_index[(df_gini_index$population=="P"),]
res_p_6_baseline <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_p[(gini_p$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_p_6_baseline
res_p_6_12 <- wilcox.test(clonal_diversification_mean~time_point, 
                              data=gini_p[(gini_p$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_p_6_12
```
...
clones_percentage_one_C <- clones_percentages_df[which(clones_percentages_df$variable %in% c("gt_10")),]
...
ggsave(plot=boxplot_clone_size, filename = paste0(abundance_dir,"/Clones_percentages_greater_than_10.png"), device="png", 
       width = 15, height = 6, units="cm")
ggsave(plot=boxplot_clone_size, filename = paste0(abundance_dir,"/Clones_percentages_greater_than_10.pdf"), device="pdf", 
       width=15, height=6, units="cm")

clones_percentage_pop <- clones_percentage_one_C[(clones_percentage_one_C$population=="M"),]
res_6_baseline <- wilcox.test(percentage~time_point, 
                              data=clones_percentage_pop[(clones_percentage_pop$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_6_baseline
res_6_12 <- wilcox.test(percentage~time_point, 
                              data=clones_percentage_pop[(clones_percentage_pop$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_6_12
res_b_12 <- wilcox.test(percentage~time_point, 
                              data=clones_percentage_pop[(clones_percentage_pop$time_point %in% c("12months","baseline")),], 
                              paired = TRUE)
res_b_12
```
...
sample_div_pop@diversity$time_point <- factor(sample_div_pop@diversity$time_point, c("baseline","6months","12months"))
...
```{r, fig.width=10, fig.asp=0.4,echo = FALSE}
...
sample_div_q1_m <- sample_div_q1[(sample_div_q1$population=="M"),]
res_m_6_baseline <- wilcox.test(d~time_point, 
                              data=sample_div_q1_m[(sample_div_q1_m$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_m_6_baseline
res_m_12_6 <- wilcox.test(d~time_point, 
                              data=sample_div_q1_m[(sample_div_q1_m$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_m_12_6
res_m_12_b <- wilcox.test(d~time_point, 
                              data=sample_div_q1_m[(sample_div_q1_m$time_point %in% c("12months","baseline")),], 
                              paired = TRUE)
res_m_12_b

sample_div_q1_dn <- sample_div_q1[(sample_div_q1$population=="DN"),]
res_dn_6_baseline <- wilcox.test(d~time_point, 
                              data=sample_div_q1_dn[(sample_div_q1_dn$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_dn_6_baseline
res_dn_12_6 <- wilcox.test(d~time_point, 
                              data=sample_div_q1_dn[(sample_div_q1_dn$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_dn_12_6

sample_div_q1_p <- sample_div_q1[(sample_div_q1$population=="P"),]
res_p_6_baseline <- wilcox.test(d~time_point, 
                              data=sample_div_q1_p[(sample_div_q1_p$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_p_6_baseline
res_p_12_6 <- wilcox.test(d~time_point, 
                              data=sample_div_q1_p[(sample_div_q1_p$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_p_12_6

sample_div_q1_n <- sample_div_q1[(sample_div_q1$population=="N"),]
sample_div_q1_n <- sample_div_q1_n[!(sample_div_q1_n$patient=="CLAD4"),]
res_n_6_baseline <- wilcox.test(d~time_point, 
                              data=sample_div_q1_n[(sample_div_q1_n$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_n_6_baseline
res_n_12_6 <- wilcox.test(d~time_point, 
                              data=sample_div_q1_n[(sample_div_q1_n$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_n_12_6



# sample_div_q1_transformed <- dcast(data=as.data.table(sample_div_q1), formula=subj_pop~time_point, fun.aggregate=sum, value.var="d")
# sample_div_q1_transformed$`6months-baseline` <- sample_div_q1_transformed$`6months` - sample_div_q1_transformed$baseline
# sample_div_q1_transformed$`12months-6months` <- sample_div_q1_transformed$`12months` - sample_div_q1_transformed$`6months`
# sample_div_q1_transformed$`12months-baseline` <- sample_div_q1_transformed$`12months` - sample_div_q1_transformed$baseline
# 
# sample_div_q1_melted <- melt(sample_div_q1_transformed, id=c("subj_pop"), measure.vars =2:7)
# sample_div_q1_melted$subject <- sapply(sample_div_q1_melted$subj_pop, function(x) unlist(strsplit(as.character(x), "_"))[1])
# sample_div_q1_melted$pop <- sapply(sample_div_q1_melted$subj_pop, function(x) unlist(strsplit(as.character(x), "_"))[2])
# sample_div_q1_melted$time_point <- sample_div_q1_melted$variable
# sample_div_q1_melted <- sample_div_q1_melted[!(variable %in% c("baseline","12months","6months")),]
# 
# diff_pop <- ggplot(sample_div_q1_melted, aes(y=value, x=pop)) +
#     geom_boxplot() +
#     geom_point(position=dodge, stat="identity", size = 1) +
#     #geom_errorbar(aes(ymin=d-d_sd, ymax=d+d_sd), width = .2, position=dodge) +
#     xlab("") + ylab("Diversity (q=1)") +
#     ggtitle(sample_main) +
#     facet_grid(cols=vars(time_point), drop=T, scales = "free") +
#     theme(axis.text.x = element_text(angle = 45, hjust = 1))
# diff_pop
```
...
```{r, echo = FALSE}
sample_div_q0$subj_pop <- paste(sample_div_q0$patient, sample_div_q0$population, sep = "_")

boxplot_pop <- ggplot(sample_div_q0, aes(y=d, x=time_point)) +
    geom_boxplot() +
    geom_point(position=dodge, stat="identity", size = 1) +
    #geom_errorbar(aes(ymin=d-d_sd, ymax=d+d_sd), width = .2, position=dodge) +
    xlab("") + ylab("Diversity (q=0)") +
...
ggsave(plot = boxplot_pop, filename = paste0(diversity_dir,"/Diversity_q0_test_boxplot_population.png"), device="png",
        width = 15, height = 6, units="cm")
ggsave(plot = boxplot_pop, filename = paste0(diversity_dir,"/Diversity_q0_test_boxplot_population.pdf"), device="pdf",
        width = 15, height = 6, units="cm")

sample_div_q0_m <- sample_div_q0[(sample_div_q0$population=="M"),]
res_m_6_baseline <- wilcox.test(d~time_point, 
                              data=sample_div_q0_m[(sample_div_q0_m$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_m_6_baseline
res_m_12_6 <- wilcox.test(d~time_point, 
                              data=sample_div_q0_m[(sample_div_q0_m$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_m_12_6
res_m_12_b <- wilcox.test(d~time_point, 
                              data=sample_div_q0_m[(sample_div_q0_m$time_point %in% c("12months","baseline")),], 
                              paired = TRUE)
res_m_12_b

sample_div_q0_dn <- sample_div_q0[(sample_div_q0$population=="DN"),]
res_dn_6_baseline <- wilcox.test(d~time_point, 
                              data=sample_div_q0_dn[(sample_div_q0_dn$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_dn_6_baseline
res_dn_12_6 <- wilcox.test(d~time_point, 
                              data=sample_div_q0_dn[(sample_div_q0_dn$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_dn_12_6

sample_div_q0_p <- sample_div_q0[(sample_div_q0$population=="P"),]
res_p_6_baseline <- wilcox.test(d~time_point, 
                              data=sample_div_q0_p[(sample_div_q0_p$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_p_6_baseline
res_p_12_6 <- wilcox.test(d~time_point, 
                              data=sample_div_q0_p[(sample_div_q0_p$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_p_12_6

sample_div_q0_n <- sample_div_q0[(sample_div_q0$population=="N"),]
sample_div_q0_n <- sample_div_q0_n[!(sample_div_q0_n$patient=="CLAD4"),]
res_n_6_baseline <- wilcox.test(d~time_point, 
                              data=sample_div_q0_n[(sample_div_q0_n$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_n_6_baseline
res_n_12_6 <- wilcox.test(d~time_point, 
                              data=sample_div_q0_n[(sample_div_q0_n$time_point %in% c("12months","6months")),], 
                              paired = TRUE)
res_n_12_6
```
...
```{r, echo=F,fig.width=10, fig.asp=0.3, fig.align='center'}
family_pop <- family[(family$population=="M"),]
...
ggsave(plot = g3, filename = paste0(vfamily_dir,"/V_gene_family_usage_boxplot_P_population.png"), device="png",
        width = 15, height = 6, units="cm")
ggsave(plot = g3, filename = paste0(vfamily_dir,"/V_gene_family_usage_boxplot_P_population.pdf"), device="pdf",
        width = 15, height = 6, units="cm")

family_pop_vh <- family_pop[(family_pop$gene=="IGHV7"),]
res_6_baseline <- wilcox.test(clone_freq~time_point, 
                              data=family_pop_vh[(family_pop_vh$time_point %in% c("baseline","6months")),], 
                              paired = TRUE)
res_6_baseline
res_12_6 <- wilcox.test(clone_freq~time_point,
                        data=family_pop_vh[(family_pop_vh$time_point %in% c("12months","6months")),],
                        paired=T)
res_12_6
```
...
```{r isotype_pop, echo=F, fig.width=15, fig.asp=0.8, fig.align='center'}
...
```{r, echo=F,fig.width=10, fig.asp=0.3, fig.align='center'}
isotype_pop <- freqs[(freqs$population=="M"),]

dodge <- position_dodge(width = 0.9)
g3 <- ggplot(isotype_pop, aes(x=extract_time, y=Freq)) +
      geom_boxplot() +
    geom_point(position=dodge, stat="identity", size=1) +

    #geom_line(aes(group=patient,color=patient)) +
    ggtitle("Isotype Usage") +
    theme(axis.text.x=element_text(angle=45, hjust=1, vjust=1)) +
    ylab("Frequency") +
    xlab("") +
    facet_grid(cols=vars(isotype), rows=vars(population), drop=T, scales = "free" ) 
    #theme(legend.position = "none") +
    #scale_colour_brewer(palette="Accent")
g3

ggsave(plot = g3, filename = paste0(isotype_dir,"/Isotype_usage_boxplot_M_population.png"), device="png",
        width = 15, height = 6, units="cm")
ggsave(plot = g3, filename = paste0(isotype_dir,"/Isotype_usage_boxplot_M_population.pdf"), device="pdf",
        width = 15, height = 6, units="cm")

isotype_pop_ig <- isotype_pop[(isotype_pop$isotype=="IgM"),]
res_6_baseline <- wilcox.test(Freq~extract_time, 
                              data=isotype_pop_ig[(isotype_pop_ig$extract_time %in% c("baseline","6months")),], 
                              paired = TRUE)
res_6_baseline
res_12_6 <- wilcox.test(Freq~extract_time,
                        data=isotype_pop_ig[(isotype_pop_ig$extract_time %in% c("12months","6months")),],
                        paired=T)
res_12_6
res_b_12 <- wilcox.test(Freq~extract_time,
                        data=isotype_pop_ig[(isotype_pop_ig$extract_time %in% c("12months","baseline")),],
                        paired=T)
res_b_12
