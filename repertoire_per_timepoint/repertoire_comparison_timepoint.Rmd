...
```{r clonal_diversity_q0_pop, fig.width=10, fig.asp = 1, echo = FALSE}
...
```{r, fig.width=6, fig.asp=1.2,echo = FALSE}
all_boxplots <- plot_grid(boxplot_gini,
                          boxplot_clone_size,
                          boxplot_divq0,
                          boxplot_divq1, 
          labels=c("A","B","C","D"),
...
```{r, fig.width=6, fig.asp=1.5,echo = FALSE}
all_boxplots_nokruskal <- plot_grid(boxplot_gini_nokruskal,
                          boxplot_clone_size_nokruskal,
                          boxplot_divq0_nokruskal,
                          boxplot_divq1_nokruskal, 
          labels=c("A","B","C","D"),
